...
if (!require("Matrix")){install.packages("Matrix")} # if required, install
library("Matrix") # load library
...
#Where 1 = one decimal place, and 2 = two decimal places. Depending on the data you may want 0,1, or 2 decimal places
...
#import the csv file
import_data <- read.csv("C:\\Users\\JoshN\\Downloads\\EEL156ReductionFile-1x3.csv")

participant_to_remove <- c("11","12" )
...
#import the csv file
import_data2 <- read.csv("C:/Users/JoshN/Downloads/EEL156ReductionFile-1x20.csv")
...
emmeans(Finger_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "0km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Finger_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "5km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Finger_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "10km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Finger_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "15km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Finger_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "20km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
#######################################################################################
...
# Step 9 - Pairwise comparisons for Condition*Distance Interaction
emmeans(Mean_Skin_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "0km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Mean_Skin_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "5km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Mean_Skin_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "10km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Mean_Skin_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "15km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Mean_Skin_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "20km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
##################################################################################
...
# Step 9 - Pairwise comparisons for Condition*Distance Interaction
emmeans(Immersion_Box_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "0km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Immersion_Box_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "5km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Immersion_Box_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "10km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Immersion_Box_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "15km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Immersion_Box_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "20km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
###########################################################################################
...
# Step 9 - Pairwise comparisons for Condition*Distance Interaction
emmeans(Hand_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "0km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Hand_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "5km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Hand_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "10km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Hand_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "15km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline
emmeans(Hand_TempxConditionxDistance.model, list(pairwise ~ Condition), at = list(Time = "20km"), adjust = "bonferroni") # pairwise comp for interaction w/ Bonferroni at baseline